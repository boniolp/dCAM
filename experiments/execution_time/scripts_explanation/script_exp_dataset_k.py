...
def exec_model(model_name,type_input,dataset_name,parameters,target_length,target_k):
	...
	file_result = "../results_explanation/log_k/{}_{}_{}.txt".format(model_name,dataset_name.split('/')[-1].strip('.pickle'),target_k)
...
if __name__ == '__main__':
	...
	device = DEVICE
	for target_length in [500]:
		for target_k in [1,2,5,10,20,50,100,200,500,1000]:
			exec_model(model_name,type_input,dataset_name,parameters,target_length,target_k)

		...
		for name in dataset_names: 
			...
			for model_name,type_input in model_names:
				...
				with open(submit_name,'w') as f:
					script_name = 'script_exp_dataset.py {} {} {} {} {} {} {}'.format(model_name,type_input,dataset_name,parameters['nb_epoch'],parameters['nb_repeat_iteration'], parameters['batch_size'], parameters['train_test_r'])
					name_job = 'synth_{}_{}'.format(model_name,name.strip('.pickle'))
